...
<head>
	<title>SEAIT-HMS Doctor Login</title>
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<p>
							...
							<span style="color:red;"><?php echo $_SESSION['<errms></errms>g']; ?><?php echo $_SESSION['errmsg'] = ""; ?></span>
						</p>
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SEAIT-CMAS</span>. <span>All rights reserved</span>
				</div>
